...
import {
  ...
  MapPin, UtensilsCrossed, Dumbbell, Target, Brain, Sparkles,
} from "lucide-react";
...
import WorkoutModule from "@/components/wellness/WorkoutModule";
...
const navItems = [
  ...
  { icon: MapPin, label: "GPS & Routes", id: "gps" },
  { icon: UtensilsCrossed, label: "Nutrition", id: "nutrition" },
  ...
  return (
    <>
      ...
      >
        ...
        {activeSection === "gps" && <div className="animate-fade-up"><GPSMap /></div>}
        {activeSection === "nutrition" && <div className="animate-fade-up"><NutritionLogger /></div>}
        {activeSection === "workout" && <div className="animate-fade-up"><WorkoutModule /></div>}
        {activeSection === "recovery" && <div className="animate-fade-up"><RecoveryPanel /></div>}
        {activeSection === "hydration" && <div className="animate-fade-up"><HydrationTracker /></div>}
        {activeSection === "mindfulness" && <div className="animate-fade-up"><MindfulnessModule /></div>}
        {activeSection === "goals" && <div className="animate-fade-up"><GoalsBiometrics /></div>}
        {activeSection === "insights" && <div className="animate-fade-up"><AIInsights /></div>}
